            ...
            <div class="col-md-6 contents">
                <div class="row justify-content-center">
                            ...
                            <form action="{{route('masyarakat.login')}}" method="POST">
                                ...
                                <div class="col-lg-11">
                                    <input type="password" name="password" id="password" class="form-control"
                                        placeholder="Password" style="outline: 0;border-width: 0 0 2px;">
                                    @error('password')
                    ...
                    <span class="ml-auto"><a href="#" class="forgot-pass">Lupa Password?</a></span> 
                            ...
                            <hr>
                            <p class="text-center mb--1">Belum punya akun?<a href="/register"> Daftar!</a></p>
                            <!-- <p class="text-center mb--2"><a href="">Lupa Password</a></p> -->
                        </div>
                    </div>
                </div>
            </div>
